    ...
    protected void init() {
        super.init();
            ...
            add1K = new Button(startX - (3 * 32) / 2, startY + modalValue.getHeight() + 3, 30, modalValue.getHeight(),
                    isAdd?
                            Component.translatable("screen.rfmeter.modalbutton.add1K"):
                            Component.translatable("screen.rfmeter.modalbutton.sub1K")
                    , this::onAdd1K);
            add1M = new Button(add1K.x + add1K.getWidth() + 2, add1K.y, 30, modalValue.getHeight(),
                    isAdd?
                            Component.translatable("screen.rfmeter.modalbutton.add1M"):
                            Component.translatable("screen.rfmeter.modalbutton.sub1G")
                    , this::onAdd1M);
            add1G = new Button(add1M.x + add1M.getWidth() + 2, add1M.y, 30, modalValue.getHeight(),
                    isAdd?
                            Component.translatable("screen.rfmeter.modalbutton.add1G"):
                            Component.translatable("screen.rfmeter.modalbutton.sub1G")
                    , this::onAdd1G);
